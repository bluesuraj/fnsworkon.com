...
<head>
    <meta charset="UTF-8"/>
    <title>Home || FNSWorkon || Online Payroll and HR Software</title>
        ...
        <div class="top-bar">
            <div class="container-fluid clearfix">
                <div class="left-content float-left">
                    <!-- <p><i class="fa fa-flag"></i>Looking for your W2, 1095-C or 1099? <a href="#">Click Here</a></p> -->
                </div><!-- /.left-content -->
                <div class="right-content float-right">
                    <ul>
                        <li>Need Help? Talk to an Expert  <span>9103370117</span></li>
            ...
            <div class="container clearfix">
                ...
                <div class="logo-box clearfix">
                    <a class="navbar-brand" href="index-2.html">
                        <img src="images/fnslogo.png" style="width: 35%;" alt="Awesome Image"/>
                    </a>
